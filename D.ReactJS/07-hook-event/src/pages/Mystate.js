...
const MyState = () => {
     ...
     * - const [변수이름, 변수에 대한 setter 함수] = React.useState(변수의 기본값);
     * - state값은 직접 변경할 수 없고 반드시 setter를 통해서만 변경 가능하다.
     * - useState() 함수에 전달하는 값은 state값에 대한 초가값이다.
     */
    ...
    const onMyNameChange = e => {
        // e.currentTaerget은 jQuery의 $(this)에 해당함.
    ...
    return (
        <div>
            ...
            {/* state값을 출력할 때는 단순히 변수 값으로서 사용한다. */}
