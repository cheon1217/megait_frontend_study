/**
 * 쿠키를 저장, 조회, 삭제하는 기능을 제공하는 helper 클래스
 */
class CookieHelper {
    /** 싱클톤 객체 */
    static #current = null;
    ...
    /**
     * 쿠키를 저장한다. 저장시 이름과 값은 내부에서 urlencoding 처리한다.
     * 
     * @params {string} name - 저장할 쿠키의 이름
     * @params {string} value - 저장할 쿠키의 값
     * @params {json} options - 유효시간, 유효경로, 도메인 등을 json으로 묶어서 보낸다.
     */
